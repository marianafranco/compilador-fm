...
% META-ANALISADOR
%*******************************************
\section{Meta-analisador}

Para facilitar o processo de obtenção dos autômatos, submáquinas, referentes aos não terminais de nossa linguagem, foi criado um meta-analisador que, a partir da gramática na notação de Wirth, automatiza a geração dos reconhecedores sintáticos. O desenvolvimento do meta-analisador seguiu as etapas apresentadas em \cite{metacompilador}.

Assim, procuramos utilizar o mesmo esquema criado para gerar o autômato na parte léxica do projeto, ou seja, primeiro descrever o autômato em XML e depois monta-lo na estrutura utilizada para sua representação dentro do compilador.
...
Para conseguir representar o autômato de pilha estruturado, representativo da gramática de wirth, constituido das submáquinas WIRTH e EXPR, utilizamos a seguinte estrutura:
...
\centering 
\theverbbox[t]\\
\caption{Estrutura do autômato da gramática de Wirth descrito em XML \label{xml}}
\end{figure}
\end{center}

% Estrutura do autômato
\subsection{Estrutura do autômato}

Além das estruturas já apresentadas no item \ref{subsub:estrutura}, criamos uma classe APE (Autômato de Pilha Estruturado), que armazena a lista de submáquinas descritas pela classe AFD (Autômato Finito Determinístico).

Assim, quando a classe responsável por montar o autômato, MontaMetaAPE, 
