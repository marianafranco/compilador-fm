...
\paragraph{Analisador semântico} O analisador semântico age juntamente com o reconhecimento do código feito pelo analisador sintático. Com o reconhecimento dos tokens, instruções MVN são geradas no arquivo de saída.
