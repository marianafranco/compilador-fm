...
A linguagem adotada no projeto corresponde à uma simplificação da linguagem de programação C, onde os comandos em inglês (IF, ELSE, FOR, ...) foram traduzidos para o português (SE, SENAO, PARA, ...).
