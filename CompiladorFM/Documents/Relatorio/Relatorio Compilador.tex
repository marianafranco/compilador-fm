...
\centering 
\theverbbox[t]\\
\caption{Autômato finito equivalente à gramática definida \label{xml}}
\end{figure}
\end{center}
...
\hline 
\end{tabular}
\caption{Relação entre a identificação da tag \emph{tipo} do XML e o tipo de token gerado \label{tipo}}
\end {table}
...
\bibitem{dragao} Neto, J. J.:
\emph{Livro do dragao}, 
1$^{a}$ edição, LTC, 1987
