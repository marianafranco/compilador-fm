...
public class PercorreAFD {
	...
	public boolean executa(AFD automato, Reader arquivoFonte, FluxoTokens tokensTokens, TabelaSimbolos tabelaSimbolos) throws IOException{
		...
		while(buffer[0] != -1) {
			...
			// Se o caracter nao for um espaço, uma quebra de linha ou uma tabulaçao
				...
				if (fechouToken == true) {
					...
					// Caso seja um numero ou um caracter, nao é necessaria uma entrada na tabela
					if (tipo == 1 || tipo == 3) {
