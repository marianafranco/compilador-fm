...
INICIO		LD	/00
		...
		MM	VAR_0
		LD	NUM_3	; VAR_1 = NUM_3
		MM	VAR_1
LOOP_0		LD	/00
		LD	VAR_0	; TEMP_0 = VAR_0
		MM	TEMP_0
		LD	VAR_1	; TEMP_1 = VAR_1
		MM	TEMP_1
...
IF_EQ_0		LD	/00
		...
		JP	ENDIF_0
ELSE_0		LD	/00	; ELSE
		LD	VAR_1	; VAR_0 = VAR_1
		MM	VAR_0
ENDIF_0		LD	/00	; END IF
		LD	VAR_0	; TEMP_0 = VAR_0 * NUM_5
		*	NUM_5
		MM	TEMP_0
		LD	TEMP_0	; TEMP_1 = TEMP_0 / VAR_0
		/	VAR_0
		MM	TEMP_1
		LD	TEMP_1	; TEMP_2 = TEMP_1 + NUM_3
		+	NUM_3
		MM	TEMP_2
		LD	TEMP_2	; VAR_0 = TEMP_2
		MM	VAR_0
		LD	VAR_0	; TEMP_0 = VAR_0
		MM	TEMP_0
		LD	TEMP_0
