...
Este projeto foi desenvolvido para a disciplina PCS2056 - Linguagens e Compiladores. Seu objetivo é a construção de um compilador que transforma uma linguagem imperativa, que será definida abaixo em código MVN.

O projeto foi desenvolvido em Java, e pode ser dividido em quatro etapas:

\begin{itemize}
\item{Definição de linguagem}
\item{Analizador léxico}
\item{Analizador sintático}
\item{Analizador sintático}
\item{Analizador semântico}
\begin{itemize}
...
Em seguida, o objeto da classe \textbf{APE} obtido é minimizado, retirando as transições em vazio, através do seu método \textbf{minimiza}. 
