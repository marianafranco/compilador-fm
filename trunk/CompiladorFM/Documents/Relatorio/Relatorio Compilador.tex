...
\begin{figure}[ht]
	\begin{center}
		\includegraphics[scale=0.50]{fig_expr.png}
...
Antes de simular o autômato de pilha estruturado da gramática de Wirth, é necessário tratar o arquivo de entrada 
